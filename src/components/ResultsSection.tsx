...
const ResultsSection = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    const selectedCourseName =
      courses.find((c) => String(c.courseId) === String(selectedCourseId))
        ?.name || "";
    ...
    const found = results.find((r) => {
      ...
      const isMobileMatch =
        String(r.mobile || "").replace(/\D/g, "") === cleanMobile;
      const isCourseMatch =
        String(r.courseId || "")
          .toLowerCase()
          .trim() ===
  ...
  return (
    <section
      id="results"
      className="py-20 md:py-24 bg-[#FAF8F3] border-y border-primary/5 relative overflow-hidden"
    >
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          ...
          <p className="font-sans text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
            Students can verify their scorecards, closed/open book evaluation
            grades, sloka marks, and certificate eligibility.
          </p>
                ...
                {!searchPerformed ? (
                  <form onSubmit={handleSearch} className="space-y-5">
                    ...
                    <div className="space-y-1.5">
                      <Label
                        htmlFor="name"
                        className="text-sm font-semibold text-[#2C1E4A]"
                      >
                        Student Name
                      </Label>
                      <Input
                    ...
                    <div className="border-2 border-dashed border-[#8B7E9F]/20 rounded-2xl p-6 bg-[#FAF8F5] relative overflow-hidden">
                      ...
                      <div className="grid grid-cols-2 gap-y-3 text-xs mb-6 font-sans">
                        ...
                        <div className="col-span-2">
                          ...
                          <span className="font-bold text-[#2C1E4A]">
                            {matchedResult.courseName}
                          </span>
                        </div>
                      </div>
                        ...
                        <table className="w-full text-xs text-left">
                          <thead>
                            <tr className="bg-secondary/40 border-b border-[#8B7E9F]/10">
                              <th className="p-3 font-semibold text-[#2C1E4A]">
                                Evaluation Subject
                              </th>
                              <th className="p-3 font-semibold text-[#2C1E4A] text-right">
                                Score
                              </th>
                            </tr>
                          </thead>
                          <tbody className="divide-y divide-[#8B7E9F]/10">
                            ...
                            <tr className="bg-secondary/20 font-bold border-t-2 border-[#8B7E9F]/15">
                              <td className="p-3 text-[#2C1E4A]">
                                Total Grade / Percentage
                              </td>
                              <td className="p-3 text-right text-accent text-sm font-extrabold">
                                {matchedResult.total}
                              </td>
                            </tr>
                          </tbody>
                      ...
                      <div className="flex items-center justify-between font-sans border-t border-[#8B7E9F]/10 pt-4 mt-4 text-xs">
                        ...
                        {matchedResult.remarks && (
                          <div className="text-right max-w-[60%]">
                            ...
                            <span className="italic font-medium text-primary block">
                              {matchedResult.remarks}
                            </span>
                          </div>
                        )}
                  ...
                  <div className="text-center py-6 font-sans space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground text-sm max-w-sm mx-auto leading-relaxed">
                        We couldn't locate any record matching the details
                        provided.
                      </p>
                    </div>
                    ...
                    <div className="bg-red-50/50 rounded-2xl p-4 border border-red-100 text-left text-xs text-red-800 space-y-1.5 max-w-sm mx-auto">
                      ...
                      <ul className="list-disc pl-4 space-y-1">
                        <li>
                          The spelling of your registered name matches the
                          registration card.
                        </li>
                        <li>
                          Mobile number is exactly 10 digits without prefix (+91
                          or 0).
                        </li>
                        <li>
                          You have chosen the correct course from the selection
                          dropdown.
                        </li>
                      </ul>
                    </div>
