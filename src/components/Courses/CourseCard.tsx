    ...
    >
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute top-4 right-4">
          <div
            className={`px-4 py-1.5 rounded-xl text-[10px] font-bold uppercase tracking-widest shadow-xl backdrop-blur-md border ${
              isRegistrationOpen
      ...
      <div className="px-4 py-2 sm:py-4 sm:px-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto flex sm:flex-row gap-4 sm:items-center justify-between pt-4 border-t border-primary/5">
          ...
          <Button variant="outline" asChild>
            <Link to={`/courses/${course.courseId}`}>See Details</Link>
          </Button>
          ...
          {/* <Button
              ...
              className={`rounded-2xl px-6 sm:px-8 font-bold transition-all duration-300 ${
                isRegistrationOpen
