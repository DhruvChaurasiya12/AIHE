  ...
  return (
    <section id="contact" className="py-20 md:py-28 bg-background">
      <div className="container mx-auto px-2">
        ...
        >
          <span className="font-sans text-orange-400 font-medium tracking-widest uppercase text-xs sm:text-sm">
            Get In Touch
          </span>
          ...
          >
            <div className="bg-primary/5 rounded-2xl p-6 sm:p-8 border border-border space-y-8">
              <div>
                ...
                <p className="font-sans text-orange-400 font-medium text-sm">
                  Avantika Institute of Higher Education (AIHE)
                </p>
                <div className="w-12 h-1 bg-orange-400 mt-4 rounded-full" />
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a
                    ...
                    className="font-sans text-foreground/80 hover:text-orange-400 transition-colors text-sm font-medium"
                  >
                    +91 8717895059
                  </a>
                </div>
          ...
          >
            ...
            >
              ...
              <Button
                ...
                className="w-full bg-orange-400 hover:bg-orange-400/90 text-accent-foreground font-sans font-medium"
              >
                {status === "sending" ? (
                  <>
